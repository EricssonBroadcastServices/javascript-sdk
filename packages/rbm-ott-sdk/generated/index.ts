...
import { CustomTranslationControllerService } from "./CustomTranslationControllerService";
...
import { LicenseControllerV2Service } from "./LicenseControllerV2Service";
import { LocationService } from "./LocationService";
import { MrssService } from "./MrssService";
import { PinCodesService } from "./PinCodesService";
import { PlaybackDevicesService } from "./PlaybackDevicesService";
...
class RBMOTTSDK {
  ...
  customTranslationController: CustomTranslationControllerService;
  ...
  epg: EpgService;
  event: EventService;
  licenseControllerV2: LicenseControllerV2Service;
  location: LocationService;
  mrss: MrssService;
  pinCodes: PinCodesService;
  playbackDevices: PlaybackDevicesService;
  ...
  constructor(public context: ServiceContext) {
    ...
    this.customTranslationController = new CustomTranslationControllerService(context);
    ...
    this.licenseControllerV2 = new LicenseControllerV2Service(context);
    this.location = new LocationService(context);
    this.mrss = new MrssService(context);
    this.pinCodes = new PinCodesService(context);
    this.playbackDevices = new PlaybackDevicesService(context);
    this.preferences = new PreferencesService(context);
    this.pushNotifications = new PushNotificationsService(context);
...
export * from "./CustomTranslationControllerService";
...
export * from "./LicenseControllerV2Service";
export * from "./LocationService";
export * from "./MrssService";
export * from "./PinCodesService";
export * from "./PlaybackDevicesService";
