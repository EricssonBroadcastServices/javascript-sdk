...
export const publicationsJson: Publication[] = [
  {
    // active publication
    countries: [],
    devices: [],
...
export const blockedPublication: Publication = {
  // active publication
  countries: ["SE"],
  devices: [],
  fromDate: new Date(Date.now() - 60 * 60000).toString(),
...
export const publicationsJsonOnlyFuture: Publication[] = [
  {
    // future publication
    countries: [],
    devices: [],
...
export const publicationsJsonOnlyActive: Publication[] & any = [
  {
    // future publication
    countries: [],
    customData: null,
