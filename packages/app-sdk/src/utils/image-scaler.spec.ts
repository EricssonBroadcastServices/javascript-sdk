...
describe("Image scaler", () => {
  it("should add query params", () => {
    ...
    expect(ImageScaler.fitToWidth("imageUrl/image.png", 400, "webp")).toBe("imageUrl/image.png?w=400&format=webp");
  });
  it("should add query params even when other query params exist", () => {
    ...
    expect(ImageScaler.fitToWidth("imageUrl/image.png?test=test", 400, "webp")).toBe(
